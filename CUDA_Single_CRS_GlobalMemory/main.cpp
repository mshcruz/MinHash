...
main(int argc, char *argv[])
{
  ...
  crsMatrix *h_characteristicMatrix = buildCharacteristicMatrix(shingleSetMap);
  std::cout << "characteristicMatrixSize: " << crsMatrixSize(h_characteristicMatrix) << "\n";
  //  printCharacteristicMatrixVectors(h_characteristicMatrix);

  std::vector<int> h_signatureMatrix(numSets*numBins);
  std::cout << "signatureMatrixSize: " << h_signatureMatrix.size() << "\n";
  ...
  */
  ...
  //computeSimilarities(h_signatureMatrix, rSize, sSize, numBins, relationRSetsID, relationSSetsID);
